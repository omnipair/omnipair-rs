...
async function main() {
    ...
    console.log('Amount:', removeAmount.toString());
    console.log('Token:', removeToken0 ? 'Token0' : 'Token1');
    ...
    const tx = await program.methods
        ...
        .accountsStrict({
            ...
            tokenVault: removeToken0 ? token0Vault : token1Vault,
            userTokenAccount: removeToken0 ? DEPLOYER_TOKEN0_ACCOUNT : DEPLOYER_TOKEN1_ACCOUNT,
            vaultTokenMint: removeToken0 ? TOKEN0_MINT : TOKEN1_MINT,
            tokenProgram: removeToken0 ? token0Program : token1Program,
