...
impl CpiEventRow {
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                                CpiEvent::AdjustCollateralEvent(_) => "adjust_collateral_event".to_string(),
                                CpiEvent::AdjustDebtEvent(_) => "adjust_debt_event".to_string(),
                                CpiEvent::AdjustLiquidityEvent(_) => "adjust_liquidity_event".to_string(),
                                CpiEvent::BurnEvent(_) => "burn_event".to_string(),
                                CpiEvent::FlashloanEvent(_) => "flashloan_event".to_string(),
                                CpiEvent::MintEvent(_) => "mint_event".to_string(),
                                CpiEvent::PairCreatedEvent(_) => "pair_created_event".to_string(),
                                CpiEvent::SwapEvent(_) => "swap_event".to_string(),
                                CpiEvent::UpdatePairEvent(_) => "update_pair_event".to_string(),
                                CpiEvent::UserLiquidityPositionUpdatedEvent(_) => "user_liquidity_position_updated_event".to_string(),
                                CpiEvent::UserPositionCreatedEvent(_) => "user_position_created_event".to_string(),
                                CpiEvent::UserPositionLiquidatedEvent(_) => "user_position_liquidated_event".to_string(),
                                CpiEvent::UserPositionUpdatedEvent(_) => "user_position_updated_event".to_string(),
                            },
