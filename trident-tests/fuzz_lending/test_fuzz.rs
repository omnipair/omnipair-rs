...
impl FuzzTest {
    ...
    // Lending flow: add collateral -> remove collateral
    #[flow(weight = 20)]
    fn lending_flow_collateral(&mut self) {
        self.add_collateral();
        self.trident.forward_in_time(60 * 60);
    ...
    fn lending_flow_liquidate(&mut self) {
        ...
        self.trident.forward_in_time(60 * 60);
        self.borrow();
        self.trident.forward_in_time(60 * 60 * 24 * 30); // Forward time significantly
        self.liquidate();
    }

    #[end]
    fn end(&mut self) {
        self.trident.forward_in_time(60 * 60 * 24);
        self.claim_protocol_fees();
    }
