...
impl<'info> AddCollateral<'info> {
    pub fn validate_add(&self, args: &AdjustCollateralArgs) -> Result<()> {
        ...
        let transfer_amount =
            transfer_amounts_from_net(&self.collateral_token_mint.to_account_info(), *amount)?;
    ...
    pub fn handle_add_collateral(ctx: Context<Self>, args: AdjustCollateralArgs) -> Result<()> {
        ...
        let transfer_amount =
            transfer_amounts_from_net(&collateral_token_mint.to_account_info(), args.amount)?;
